...
You can get the R markdown source of this document with
```{r eval=FALSE}
edit(vignette("model_exploration", package = "mizerShelf"))
```
and then change the parameter values to explore how the results depend on those choices.
