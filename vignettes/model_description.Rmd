...
<details>
<summary>Parameter values</summary>
In the steady state the total carrion biomass is \( B_C = `r signif(carrion_biomass(params), digits = 4)`\) grams. This was chosen so that under
the given consumption, the expected lifetime for the carrion biomass,
...
In the steady state the total detritus biomass is \( B_D = `r signif(detritus_biomass(params), digits = 4)`\) grams. This was chosen so that under
the given consumption, the expected lifetime for the detritus biomass,
